...
public class MainActivity extends AppCompatActivity {
    ...
    private boolean eliminar(){
        ...
        HttpPost httppost;
        httpclient=new DefaultHttpClient();
        httppost= new HttpPost("http://192.168.1.33/ws_insertar/eliminar.php"); // Url del Servidor
        //Añadimos nuestros datos
        ...
        protected String doInBackground(String... params) {
            ...
            if(eliminar())
                context.runOnUiThread(new Runnable(){
                    ...
                    public void run() {
                        // TODO Auto-generated method stub
                        Toast.makeText(context, "Persona borrada con éxito", Toast.LENGTH_LONG).show();
                        nombre.setText("");
                        dni.setText("");
                        telefono.setText("");
                        email.setText("");
                ...
                context.runOnUiThread(new Runnable(){
                    ...
                    public void run() {
                        // TODO Auto-generated method stub
                        Toast.makeText(context, "Persona no borrada con éxito", Toast.LENGTH_LONG).show();
                    }
                });
            return null;
        }
